...
public class PanelMapaVisualizar extends JPanel
{
    ...
    {
    	this.labMapa = new JLabel(new ImageIcon("uniandes/dpoo/swing/imagenes/mapa.png"));
    ...
    public void paint( Graphics g )
    {
        ...
        if (restaurantes != null && !restaurantes.isEmpty()) {
            ...
            for (Restaurante r : restaurantes) {
                // color si fue visitado
                Color color = r.isVisitado() ? Color.GREEN : Color.RED;
                g2d.setColor(color);
                
                // dibuja circulo en cordenadas
                int x = r.getX(); // cordenadas del restaurante
                int y = r.getY();
                g2d.fillOval(x - 5, y - 5, 10, 10); // circulo de radio 5
                g2d.setColor(Color.BLACK);
                g2d.drawString(r.getNombre(), x + 10, y + 5);
            }
        }
    }
